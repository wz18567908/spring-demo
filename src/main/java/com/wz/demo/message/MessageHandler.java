...
public class MessageHandler {
    ...
    private static String handleTextMessage(Map map) {
        ...
        default:
            xml = String.format(
                    ...
                    msg.Receiver, msg.Sender, msg.CreateTime, "请回复如下关键词：\n文本\n图片\n语音\n视频\n音乐\n图文");
            break;
        }
        return xml;
    }
    ...
    private static String buildMusic(Map map) {
        ...
        return String.format(
                ...
                msg.Receiver, msg.Sender, getUtcTime(), msg.Title, msg.Description, msg.MusicURL, msg.HQMusicUrl,
                msg.ThumbMediaId);
    }
    ...
    private static String buildNewsMessage(Map map) {
        ...
        String content = String.format(
                "<xml>\n" + "<ToUserName><![CDATA[%s]]></ToUserName>\n"
                        ...
                        + "%s" + "</Articles>\n" + "</xml> ",
                fromUserName, toUserName, getUtcTime(), 2, itemContent1 + itemContent2);
        return content;
